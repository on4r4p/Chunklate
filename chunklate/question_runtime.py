...
def _question_prompt_text(question_id: Any, skipauto: bool) -> str:
    ...
    if "IDAT Interruption Move" in str(question_id):
        return "Question: Should i move this ancillary chunk out of the IDAT chain?"
    ...
    if "Ultimate Visual ROI Snapshot" in str(question_id):
        return "Question: Use the visible Ultimate preview in the ROI editor? yes=preview, no=_ULF.Source.png"
