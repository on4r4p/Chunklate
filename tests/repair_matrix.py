...
REPAIR_MATRIX: tuple[RepairCase, ...] = (
    ...
    RepairCase(
        ...
        max_saves=2,
        expected_outputs=("Private_Critical_Chunk_Bad_Crc.0_Fixed.png",),
    ),
    RepairCase(
        ...
        expected_strategy="remove unsafe private critical chunk",
        max_saves=2,
        expected_outputs=("Private_Critical_Chunk_Crc_Valid.0_Fixed.png",),
    ),
    RepairCase(
    ...
    RepairCase(
        ...
        expected_strategy="repair chunk name",
        max_saves=2,
        expected_outputs=("Wrong-Chunk-Name-Crc-Valid.0_Fixed.png",),
    ),
    RepairCase(
    ...
    RepairCase(
        ...
        expected_strategy="remove unsafe private critical chunk",
        max_saves=2,
        expected_outputs=("chunk_private_critical_badcrc.0_Fixed.png",),
    ),
    RepairCase(
        ...
        expected_strategy="remove unsafe private critical chunk",
        max_saves=2,
        expected_outputs=("chunk_private_critical_goodcrc.0_Fixed.png",),
    ),
    RepairCase(
        ...
        expected_strategy="repair chunk name",
        max_saves=2,
        expected_outputs=("chunk_type.0_Fixed.png",),
    ),
    RepairCase(
...
UNCOVERED_REPAIR_CASES: dict[str, str] = {
    ...
    "IDAT_Corruption_1.png": "large multi-IDAT corruption fixture kept for manual partial-IDAT blackfill testing",
    "IDAT_Corruption_2.png": "large multi-IDAT corruption fixture kept for manual partial-IDAT blackfill testing",
    ...
    "plte_empty.png": "PLTE payload fixture covered by targeted palette tests; not yet in strict repair matrix",
    "plte_in_grayscale.png": "PLTE color-type fixture covered by targeted palette tests; not yet in strict repair matrix",
    "plte_too_many_entries_2.png": "PLTE entry-count fixture covered by targeted palette tests; not yet in strict repair matrix",
    "private_bzip2_missing_bz_idat.png": "private compression wrapper fixture covered by targeted private-compression tests; not yet in strict repair matrix",
    "private_compression_method.png": "private compression-method fixture covered by targeted tests; not yet in strict repair matrix",
    "private_filter_method.png": "private filter-method fixture covered by targeted tests; not yet in strict repair matrix",
    "private_filter_type.png": "private filter-type fixture covered by targeted tests; not yet in strict repair matrix",
    "private_gzip_false_positive_idat.png": "private compression wrapper fixture covered by targeted private-compression tests; not yet in strict repair matrix",
    "private_gzip_missing_byte_idat.png": "private compression wrapper fixture covered by targeted private-compression tests; not yet in strict repair matrix",
    "private_interlace_method.png": "private interlace-method fixture covered by targeted tests; not yet in strict repair matrix",
    "private_raw_deflate_idat.png": "private compression wrapper fixture covered by targeted private-compression tests; not yet in strict repair matrix",
    "private_targz_single_entry_idat.png": "private compression wrapper fixture covered by targeted private-compression tests; not yet in strict repair matrix",
    "private_xz_missing_two_bytes_idat.png": "private compression wrapper fixture covered by targeted private-compression tests; not yet in strict repair matrix",
    "private_zip_ambiguous_entries_idat.png": "private compression wrapper fixture covered by targeted private-compression tests; not yet in strict repair matrix",
    "private_zip_single_entry_idat.png": "private compression wrapper fixture covered by targeted private-compression tests; not yet in strict repair matrix",
    "private_zlib_idat.png": "private compression wrapper fixture covered by targeted private-compression tests; not yet in strict repair matrix",
    "sbit_after_idat.png": "misplaced sBIT fixture covered by targeted runtime tests; not yet in strict repair matrix",
    "sbit_after_plte.png": "misplaced sBIT fixture covered by targeted runtime tests; not yet in strict repair matrix",
    "sbit_sample_depth.png": "sBIT sample-depth fixture covered by targeted tests; not yet in strict repair matrix",
    "sbit_sample_depth_2.png": "sBIT sample-depth fixture covered by targeted tests; not yet in strict repair matrix",
    "scal_after_idat.png": "misplaced sCAL fixture covered by targeted tests; not yet in strict repair matrix",
    "splt_after_idat.png": "misplaced sPLT fixture covered by targeted tests; not yet in strict repair matrix",
    "splt_duplicate_name.png": "sPLT duplicate-name fixture covered by targeted tests; not yet in strict repair matrix",
    "splt_length_mod_10.png": "sPLT length fixture covered by targeted tests; not yet in strict repair matrix",
    "splt_length_mod_6.png": "sPLT length fixture covered by targeted tests; not yet in strict repair matrix",
    "splt_sample_depth.png": "sPLT sample-depth fixture covered by targeted tests; not yet in strict repair matrix",
    "scal_floating_point.png": "sCAL floating-point payload fixture covered by targeted tests; not yet in strict repair matrix",
    "scal_negative.png": "sCAL negative scale fixture covered by targeted tests; not yet in strict repair matrix",
    "scal_unit_specifier.png": "sCAL unit specifier fixture covered by targeted tests; not yet in strict repair matrix",
    "scal_zero.png": "sCAL zero scale fixture covered by targeted tests; not yet in strict repair matrix",
    "srgb_after_idat.png": "misplaced sRGB fixture covered by targeted tests; not yet in strict repair matrix",
    "srgb_after_plte.png": "misplaced sRGB fixture covered by targeted tests; not yet in strict repair matrix",
    "ster_after_idat.png": "misplaced sTER fixture covered by targeted tests; not yet in strict repair matrix",
    "ster_mode.png": "sTER mode fixture covered by targeted tests; not yet in strict repair matrix",
    "text_trailing_null.png": "tEXt payload fixture covered by targeted text tests; not yet in strict repair matrix",
    "time_value_range.png": "tIME range fixture covered by targeted tests; not yet in strict repair matrix",
    "trns_after_idat.png": "misplaced tRNS fixture covered by targeted tests; not yet in strict repair matrix",
    "trns_bad_color_type.png": "tRNS color-type fixture covered by targeted tests; not yet in strict repair matrix",
    "trns_too_many_entries.png": "tRNS payload fixture covered by targeted tests; not yet in strict repair matrix",
    "truncate_idat_0.png": "truncated IDAT fixture covered by targeted IDAT tests; not yet in strict repair matrix",
    "truncate_idat_1.png": "truncated IDAT fixture covered by targeted IDAT tests; not yet in strict repair matrix",
    "truncate_zlib.png": "truncated zlib fixture covered by targeted IDAT tests; not yet in strict repair matrix",
    "truncate_zlib_2.png": "truncated zlib fixture covered by targeted IDAT tests; not yet in strict repair matrix",
    "unknown_filter_type.png": "invalid IDAT filter fixture covered by targeted IDAT tests; not yet in strict repair matrix",
    "xc9n2c08.png": "invalid color-type/bit-depth sample covered by targeted tests; not yet in strict repair matrix",
    "xcrn0g04.png": "invalid compression-method sample covered by targeted tests; not yet in strict repair matrix",
    "xcsn0g01.png": "IDAT CRC fixture covered by targeted wrong-CRC tests; not yet in strict repair matrix",
    "xd0n2c08.png": "invalid IHDR sample covered by targeted tests; not yet in strict repair matrix",
    "xd3n2c08.png": "invalid IHDR sample covered by targeted tests; not yet in strict repair matrix",
    "xd9n2c08.png": "invalid IHDR sample covered by targeted tests; not yet in strict repair matrix",
    "xhdn0g08.png": "invalid IHDR sample covered by targeted tests; not yet in strict repair matrix",
    "xlfn0g04.png": "line-feed signature sample covered by targeted tests; not yet in strict repair matrix",
    "xs1n0g01.png": "invalid sample-depth fixture covered by targeted tests; not yet in strict repair matrix",
    "xs2n0g01.png": "invalid sample-depth fixture covered by targeted tests; not yet in strict repair matrix",
    "xs4n0g01.png": "invalid sample-depth fixture covered by targeted tests; not yet in strict repair matrix",
    "ztxt_compression_method.png": "zTXt compression-method fixture covered by targeted text tests; not yet in strict repair matrix",
    "ztxt_data_format.png": "zTXt data-format fixture covered by targeted text tests; not yet in strict repair matrix",
    "noidat.png": "terminal malformed PNG with no IDAT image stream to recover",
    "x00n0g01.png": "irreparable zero-dimension PNG with no IDAT image stream to recover",
    "xdtn0g01.png": "terminal malformed PNG with no IDAT image stream to recover",
    "xc1n0g08.png": "invalid IHDR color type fixture covered by targeted IHDR rebuild tests; not yet in strict repair matrix",
